/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker-configuration.d.ts` (hash: 37781bd35d50ae78e4292bdf35b9e86b)
...
interface __BaseEnv_Env {
	...
	GITHUB_REF: "main";
	OTA_INSTALL_URL: "itms-services://?action=download-manifest&url=https://bulai0408.github.io/Asspp/ios/latest/manifest.plist";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPOSITORY" | "GITHUB_WORKFLOW" | "GITHUB_REF" | "OTA_INSTALL_URL">> {}
}
